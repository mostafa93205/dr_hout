...
import { Plus, Trash2, Edit, X, ChevronDown, ChevronUp, Search, Upload, Loader2, Image } from "lucide-react"
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-gray-500 dark:text-gray-400">
            {isEnglish ? "Add, edit, and manage your projects" : "إضافة وتعديل وإدارة المشاريع الخاصة بك"}
          </p>
        </div>
      </div>
                ...
                >
                  ...
                  <DialogContent>
                    ...
                    <DialogFooter>
                      ...
                      <Button variant="destructive" onClick={() => handleDeleteProject(project.id)} disabled={loading}>
                        {loading ? (
                          <>
                            <Loader2 className="mr-2 h-4 w-4 animate-spin" />
                  ...
                  <DialogContent className="sm:max-w-[600px]">
                    ...
                    {editingProject && (
                      <div className="grid gap-4 py-4">
                        ...
                        <div className="grid gap-2">
                          <Label htmlFor="edit-imageUrl">{isEnglish ? "Project Image URL" : "رابط صورة المشروع"}</Label>
                          <Input
                            id="edit-imageUrl"
